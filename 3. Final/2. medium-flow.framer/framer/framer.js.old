...
/***/ function(module, exports, __webpack_require__) {
	...
	Framer.Utils = __webpack_require__(/*! ./Utils */ 2);
	
	Framer.Layer = (__webpack_require__(/*! ./Layer */ 3)).Layer;
	
	Framer.BackgroundLayer = (__webpack_require__(/*! ./BackgroundLayer */ 4)).BackgroundLayer;
	
	Framer.VideoLayer = (__webpack_require__(/*! ./VideoLayer */ 5)).VideoLayer;
	
	Framer.Events = (__webpack_require__(/*! ./Events */ 6)).Events;
	
	Framer.Animation = (__webpack_require__(/*! ./Animation */ 7)).Animation;
	
	Framer.AnimationGroup = (__webpack_require__(/*! ./AnimationGroup */ 8)).AnimationGroup;
	
	Framer.Screen = (__webpack_require__(/*! ./Screen */ 9)).Screen;
	
	Framer.Canvas = (__webpack_require__(/*! ./Canvas */ 10)).Canvas;
	
	Framer.print = (__webpack_require__(/*! ./Print */ 11)).print;
	
	Framer.ScrollComponent = (__webpack_require__(/*! ./Components/ScrollComponent */ 12)).ScrollComponent;
	
	Framer.PageComponent = (__webpack_require__(/*! ./Components/PageComponent */ 13)).PageComponent;
	
	Framer.SliderComponent = (__webpack_require__(/*! ./Components/SliderComponent */ 14)).SliderComponent;
	
	Framer.DeviceComponent = (__webpack_require__(/*! ./Components/DeviceComponent */ 15)).DeviceComponent;
	...
	Framer.Context = (__webpack_require__(/*! ./Context */ 16)).Context;
	
	Framer.Config = (__webpack_require__(/*! ./Config */ 17)).Config;
	
	Framer.EventEmitter = (__webpack_require__(/*! ./EventEmitter */ 18)).EventEmitter;
	
	Framer.BaseClass = (__webpack_require__(/*! ./BaseClass */ 19)).BaseClass;
	
	Framer.LayerStyle = (__webpack_require__(/*! ./LayerStyle */ 20)).LayerStyle;
	
	Framer.AnimationLoop = (__webpack_require__(/*! ./AnimationLoop */ 21)).AnimationLoop;
	
	Framer.LinearAnimator = (__webpack_require__(/*! ./Animators/LinearAnimator */ 22)).LinearAnimator;
	
	Framer.BezierCurveAnimator = (__webpack_require__(/*! ./Animators/BezierCurveAnimator */ 23)).BezierCurveAnimator;
	
	Framer.SpringDHOAnimator = (__webpack_require__(/*! ./Animators/SpringDHOAnimator */ 24)).SpringDHOAnimator;
	
	Framer.SpringRK4Animator = (__webpack_require__(/*! ./Animators/SpringRK4Animator */ 25)).SpringRK4Animator;
	
	Framer.LayerDraggable = (__webpack_require__(/*! ./LayerDraggable */ 26)).LayerDraggable;
	
	Framer.Importer = (__webpack_require__(/*! ./Importer */ 27)).Importer;
	
	Framer.Debug = (__webpack_require__(/*! ./Debug */ 28)).Debug;
	
	Framer.Extras = __webpack_require__(/*! ./Extras/Extras */ 29);
	...
	Defaults = (__webpack_require__(/*! ./Defaults */ 30)).Defaults;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports._ = __webpack_require__(/*! lodash */ 39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Screen = __webpack_require__(/*! ./Screen */ 9).Screen;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Config = __webpack_require__(/*! ./Config */ 17).Config;
	
	Defaults = __webpack_require__(/*! ./Defaults */ 30).Defaults;
	
	BaseClass = __webpack_require__(/*! ./BaseClass */ 19).BaseClass;
	
	EventEmitter = __webpack_require__(/*! ./EventEmitter */ 18).EventEmitter;
	
	Animation = __webpack_require__(/*! ./Animation */ 7).Animation;
	
	LayerStyle = __webpack_require__(/*! ./LayerStyle */ 20).LayerStyle;
	
	LayerStates = __webpack_require__(/*! ./LayerStates */ 31).LayerStates;
	
	LayerDraggable = __webpack_require__(/*! ./LayerDraggable */ 26).LayerDraggable;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Layer = __webpack_require__(/*! ./Layer */ 3).Layer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	LinearAnimator = __webpack_require__(/*! ./Animators/LinearAnimator */ 22).LinearAnimator;
	
	BezierCurveAnimator = __webpack_require__(/*! ./Animators/BezierCurveAnimator */ 23).BezierCurveAnimator;
	
	SpringRK4Animator = __webpack_require__(/*! ./Animators/SpringRK4Animator */ 25).SpringRK4Animator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Events = __webpack_require__(/*! ./Events */ 6).Events;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Context = __webpack_require__(/*! ./Context */ 16).Context;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ScrollComponent = (function(superClass) {
	  ...
	  function ScrollComponent(options) {
	    ...
	    this._contentInset = options.contentInset || Utils.zeroRect();
	  ...
	  ScrollComponent.define("scrollX", {
	    get: function() {
	      ...
	      return -this.content.x + this.contentInset.left;
	    },
	    set: function(value) {
	      if (!this.content) {
	        return;
	      }
	      return this.content.x = -this._pointInConstraints({
	        x: value - this.contentInset.left,
	        y: 0
	      }).x;
	    }
	  });
	  ...
	  ScrollComponent.define("scrollY", {
	    get: function() {
	      ...
	      return -this.content.y + this.contentInset.top;
	    },
	    set: function(value) {
	      if (!this.content) {
	        return;
	      }
	      return this.content.y = -this._pointInConstraints({
	        x: 0,
	        y: value - this.contentInset.top
	      }).y;
	    }
	  });
	  ...
	  ScrollComponent.define("contentInset", {
	    ...
	    set: function(contentInset) {
	      this._contentInset = Utils.zeroRect(Utils.parseRect(contentInset));
	  ...
	  ScrollComponent.prototype.scrollToPoint = function(point, animate, animationOptions) {
	    ...
	    point = this._pointInConstraints(point);
	    if (animate) {
	      if (point.x) {
	        point.x = -point.x;
	      }
	  ...
	  ScrollComponent.wrap = function(layer) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	ScrollComponent = __webpack_require__(/*! ./ScrollComponent */ 12).ScrollComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SliderComponent = (function(superClass) {
	  ...
	  function SliderComponent(options) {
	    ...
	    this.knob.borderRadius = this.knob.width;
	    this.fill = new Layer({
	      backgroundColor: "#333",
	      superLayer: this,
	      height: this.height,
	    ...
	    this.fill.force2d = true;
	    this.knob.placeBefore(this.fill);
	    this._updateFrame();
	    ...
	    this.on(Events.MouseDown, this._touchDown);
	    this.on(Events.TouchDown, this._touchDown);
	  ...
	  SliderComponent.prototype._touchDown = function(event) {
	    ...
	    this.value = this.valueForPoint(event.x - this.canvasFrame.x);
	  ...
	  SliderComponent.prototype._updateFrame = function() {
	    this.knob.draggable.constraints = {
	      x: -this.knobSize / 2,
	      y: -this.knobSize / 2,
	      width: this.width + this.knobSize,
	      height: this.height + this.knobSize
	    };
	  ...
	  SliderComponent.define("value", {
	    ...
	    set: function(value) {
	      return this.knob.midX = this.pointForValue(value);
	    }
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	EventManager = __webpack_require__(/*! ./EventManager */ 32).EventManager;
...
/***/ function(module, exports, __webpack_require__) {
	...
	EventEmitter = __webpack_require__(/*! eventemitter3 */ 40).EventEmitter;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.BaseClass = (function(superClass) {
	  ...
	  BaseClass.prototype.toInspect = function() {
	    return "<" + this.constructor.name + " id:" + this.id + " " + (Utils.inspect(this.props, 3));
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Animator = __webpack_require__(/*! ../Animator */ 33).Animator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Integrator = __webpack_require__(/*! ../Integrator */ 34).Integrator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Simulation = __webpack_require__(/*! ./Simulation */ 35).Simulation;
	
	Defaults = __webpack_require__(/*! ./Defaults */ 30).Defaults;
	
	EventBuffer = __webpack_require__(/*! ./EventBuffer */ 36).EventBuffer;
	...
	exports.LayerDraggable = (function(superClass) {
	  ...
	  LayerDraggable.prototype._touchStart = function(event) {
	    ...
	    this._canvasFrame = {
	      x: this.layer.canvasScaleX(),
	      y: this.layer.canvasScaleY()
	    };
	  ...
	  LayerDraggable.prototype._touchMove = function(event) {
	    ...
	    offset.x = offset.x * this.speedX * (1 / this._canvasFrame.x) * this.layer.scaleX * this.layer.scale;
	    offset.y = offset.y * this.speedY * (1 / this._canvasFrame.y) * this.layer.scaleY * this.layer.scale;
	  ...
	  LayerDraggable.prototype._startSimulation = function() {
	    ...
	    if (this.isDragging === false && this.isBeyondConstraints === false) {
	      return;
	    }
	    ref = this._calculateConstraints(this._constraints), minX = ref.minX, maxX = ref.maxX, minY = ref.minY, maxY = ref.maxY;
	    ...
	    velocity = this.velocity;
	    velocityX = velocity.x * this.momentumVelocityMultiplier * this.speedX * (1 / this._canvasFrame.x) * this.layer.scaleX * this.layer.scale;
	    velocityY = velocity.y * this.momentumVelocityMultiplier * this.speedY * (1 / this._canvasFrame.y) * this.layer.scaleY * this.layer.scale;
	  ...
	  LayerDraggable.prototype._stopSimulation = function() {
	    ...
	    if ((ref = this._simulation.x) != null) {
	      ref.stop();
	    }
	    if ((ref1 = this._simulation.y) != null) {
	      ref1.stop();
	    }
	    this.emit(Events.Move, this.layer.point);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.MobileScrollFix = __webpack_require__(/*! ./MobileScrollFix */ 37);
	
	exports.OmitNew = __webpack_require__(/*! ./OmitNew */ 38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	SpringSimulator = __webpack_require__(/*! ./Simulators/SpringSimulator */ 41).SpringSimulator;
	
	FrictionSimulator = __webpack_require__(/*! ./Simulators/FrictionSimulator */ 42).FrictionSimulator;
	
	MomentumBounceSimulator = __webpack_require__(/*! ./Simulators/MomentumBounceSimulator */ 43).MomentumBounceSimulator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Simulator = __webpack_require__(/*! ../Simulator */ 45).Simulator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	SpringSimulator = __webpack_require__(/*! ./SpringSimulator */ 41).SpringSimulator;
	
	FrictionSimulator = __webpack_require__(/*! ./FrictionSimulator */ 42).FrictionSimulator;
